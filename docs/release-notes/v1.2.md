...
::: tip
Debian 8 is no longer supported as it has reached EOL (end-of-life) status.
:::
...
::: tip
Custom phpMyAdmin and phpPgAdmin URL's will be reset once during this upgrade to correct a legacy code issue.
:::
